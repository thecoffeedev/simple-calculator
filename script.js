document.body.style.backgroundImage = "url('./images/w1.jpg')";
...
alert.innerHTML = "<strong>Note: </strong> You can also use keyboard to type the numbers and operators.";
col2.appendChild(alert);
